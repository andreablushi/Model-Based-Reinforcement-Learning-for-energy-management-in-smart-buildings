...
def plot_energy(
    ...
    suffix : str, optional
        Suffix to append to the saved figure filename for identification.
...
if __name__ == '__main__':
    ...
    plot_energy(
        cooling_device_consumption=res_comfort_rbc['env_h']['cooling_device']['consumption'],
        dhw_device_consumption=res_comfort_rbc['env_h']['dhw']['consumption'],
        non_shiftable_load=res_comfort_rbc['env_h']['non_shiftable_load'],
        battery_charge=res_comfort_rbc['env_h']['battery']['consumption'],
        pv_generation=res_comfort_rbc['env_h']['solar_generation'],
        battery_action=res_comfort_rbc['env_h']['battery']['discharge'],
        battery_soc=res_comfort_rbc['env_h']['battery']['soc'],
        net_load=res_comfort_rbc['env_h']['net_electricity_consumption'],
        suffix='comfort_rbc'
    )
    # Plot energy profile for Advanced RBC
    plot_energy(
        cooling_device_consumption=res_advanced_rbc['env_h']['cooling_device']['consumption'],
        dhw_device_consumption=res_advanced_rbc['env_h']['dhw']['consumption'],
        non_shiftable_load=res_advanced_rbc['env_h']['non_shiftable_load'],
        battery_charge=res_advanced_rbc['env_h']['battery']['consumption'],
        pv_generation=res_advanced_rbc['env_h']['solar_generation'],
        battery_action=res_advanced_rbc['env_h']['battery']['discharge'],
        battery_soc=res_advanced_rbc['env_h']['battery']['soc'],
        net_load=res_advanced_rbc['env_h']['net_electricity_consumption'],
        suffix='advanced_rbc'
    )
