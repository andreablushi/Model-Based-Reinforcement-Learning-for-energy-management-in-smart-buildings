...
class TimeSeriesEnsemble:
    def __init__(self, steps_ahead, variable_name, use_pretrained, use_xgboost, use_historical,
        ...
        if use_pretrained:
            from agents.checa.forecast_agent.pretrained_xgboost import PreTrainedXGBoost
            self.pretrained_xgboost = PreTrainedXGBoost(steps_ahead, variable_name)

        self.use_xgboost = use_xgboost
        if use_xgboost:
            from agents.checa.forecast_agent.online_xgboost import OnlineXGBoost
            self.xgboost = OnlineXGBoost(steps_ahead, variable_name)

        self.use_historical = use_historical
        if use_historical:
            from agents.checa.forecast_agent.historical_predictor import Historical
