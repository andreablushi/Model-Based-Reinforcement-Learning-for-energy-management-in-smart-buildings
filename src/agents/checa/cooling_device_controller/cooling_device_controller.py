import numpy as np
from agents.checa.cooling_device_controller.pid_controller import PIDController
...
class CoolingDeviceController:
    ...
    def find_best_action(self, obs, pred_out_temp, last_step_demand, outage_details,
        ...
        temp_setpoint = obs[self.observation_names_b.index(f'indoor_dry_bulb_temperature_cooling_set_point_{self.b}')]
